  ...
  return (
    <footer className="bg-gradient-to-b from-gray-50 to-gray-100 border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-16">
      <div className="max-w-7xl mx-auto grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            Empowering educational institutions with data-driven insights, leadership development,
            and transformative strategies for the modern learning environment.
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex rounded-lg overflow-hidden shadow-sm">
              ...
              />
              <button className="bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-3 hover:opacity-90 transition-opacity text-sm font-medium">
                Join
              </button>
            </div>
          </div>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6 pb-2 border-b border-orange-500">Explore</h3>
        ...
        {/* Contact Info */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6 pb-2 border-b border-orange-500">Get in touch</h3>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <HiOutlineLocationMarker className="mt-1 shrink-0 text-orange-500" size={18} />
              <span className="text-gray-600">
                B2/901, Cherry County, Techzone-IV,<br />
        ...
        {/* Social & Payments */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6 pb-2 border-b border-orange-500">Connect</h3>
      ...
      <div className="max-w-7xl mx-auto border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
        <p>© {new Date().getFullYear()} EdVantage 360 Solutions. All rights reserved.</p>
        <div className="flex gap-4 mt-4 md:mt-0">
          <NavLink to="/privacy" className="hover:text-green-600 hover:underline">Privacy Policy</NavLink>
          
                    <NavLink to="/cookies" className="hover:text-green-600 hover:underline">Cookie Policy</NavLink>

          <NavLink to="/terms" className="hover:text-green-600 hover:underline">Terms of Service</NavLink>
        </div>
      </div>
    </footer>
  );
