    ...
    <div className="relative bg-gradient-to-r from-[#A43E27] to-[#D15A39] py-16 px-6 sm:px-12 lg:px-24 shadow-xl overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">
          What is <span className="text-yellow-200">EdVantage 360 Solutions</span>?
        </h2>
        
        <div className={`text-white text-lg leading-relaxed transition-all duration-500 ease-in-out ${showFullText ? 'max-h-[500px]' : 'max-h-24'} overflow-hidden`}>
