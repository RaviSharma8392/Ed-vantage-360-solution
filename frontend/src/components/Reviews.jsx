const reviews = [
  {
    ...
    content:
      "EdVantage 360 transformed our entire academic and administrative approach. Their leadership training and academic audits brought clarity, purpose, and results. We’re seeing measurable improvements in both student engagement and faculty performance.",
  ...
  },
  {
    ...
    content:
      "From infrastructure and uniforms to digital classrooms and student workshops, EdVantage 360 has been our go-to partner. Their 360° support really takes the stress out of managing multiple vendors.",
  ...
  },
  {
    ...
    content:
      "We needed end-to-end support for setting up a vocational training centre. EdVantage 360 not only provided it but also guided us on branding, promotion, and student placement. Exceptional!",
