...
export const registrationConfig = {
  endDate: "2026-01-13",
  formLink:
    "https://docs.google.com/forms/d/e/1FAIpQLSdor0_bSJVFoVCFDwAwad8PY_G7W84YQg3JycIAYBWPWFfn0Q/viewform?pli=1",
};
...
export const eventData = {
  ...
  ctaButton: {
    ...
    href: registrationConfig.formLink,
  },
  ...
  aboutData: {
    mainTitle: "About EdVantage Laureates – Tech Star Awards 2026",
    tagline: "Education with Purpose, Values for Life",
    sections: [
      {
        title: "Theme of Transformation",
        desc: "Recognising schools as catalysts of transformation.",
      },
      {
        title: "Purpose with Heart",
        desc: "India’s Biggest Teacher Awards Series.",
      },
    ],
  },
...
export const awardData = {
  header: {
    title: "EdVantage Laureates – Tech Star Awards 2026 4th Edition",
    subtitle: "Celebrating leaders shaping the future of learning.",
  },
  categories: [
